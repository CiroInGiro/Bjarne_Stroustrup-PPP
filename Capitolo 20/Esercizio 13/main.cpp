/*
Capitolo 20 Esercizio 13
Non abbiamo veramente bisogno di un vero Link dopo l'ultimo ad indicare la fine della lista.
Modifica la tua soluzione dell'esercizio precedente per usare 0 ad indicare un puntatore ad un Link inesistente (list<Elem>::end()).
In questo modo la dimensione della lista può essere uguale alla dimensione di un singolo puntatore.
*/
...
public:
	...
	// core della lista
	list() : primo{ new Elem() }, ultimo{ nullptr } {}
	iterator begin() {
