...
struct test {
	...
	// manda sull'output stream il nome del test
	std::ostream& stampa_nome(std::ostream& out) {
		out << nome_test;
		return out;
	}
	
	// manda sull'output stream i risultati del test
