...
struct Color {
	...
	Color(Fl_Color cc) : c{ cc }, v{ visible } {} // Modifica da C++11 a C++14
	Color(Transparency vv) :c(Fl_Color()), v(vv) { }
	int as_int() const { return c; }
	char visibility() const { return v; }
	void set_visibility(Transparency vv) { v=vv; }
	friend std::ostream& operator<<(std::ostream& os, const Graph_lib::Color& colore);
	friend std::istream& operator>>(std::istream& is, Graph_lib::Color& colore);
private:
...
public:
	Shape() { } // spostato qui x Try This 1
protected:
	//Shape() { }
...
struct Circle : Shape {
	...
	// costruttore di copia x Try This 1
