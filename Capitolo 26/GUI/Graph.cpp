...
namespace Graph_lib {
	...
	std::ostream& operator<<(std::ostream& os, const Graph_lib::Color& colore) {
		os << "Color{";
	...
	std::istream& operator>>(std::istream& is, Graph_lib::Color& colore) {
		char ch{ '\0' };
		std::string comando;

		while (is >> ch && ch != '{') comando += ch;

		if (comando != "Color") return is;

		comando = "";

		while (is >> ch && ch != '}') comando += ch;

		if (comando == "white") colore = Color::white;
		else if (comando == "black") colore = Color::black;
		else if (comando == "red") colore = Color::red;
		else if (comando == "green") colore = Color::green;
		else if (comando == "blue") colore = Color::blue;
		else if (comando == "yellow") colore = Color::yellow;
		else if (comando == "magenta") colore = Color::magenta;
		else if (comando == "cyan") colore = Color::cyan;
		else if (comando == "dark_red") colore = Color::dark_red;
		else if (comando == "dark_green") colore = Color::dark_green;
		else if (comando == "dark_blue") colore = Color::dark_blue;
		else if (comando == "dark_yellow") colore = Color::dark_yellow;
		else if (comando == "dark_magenta") colore = Color::dark_magenta;
		else if (comando == "dark_cyan") colore = Color::dark_cyan;
